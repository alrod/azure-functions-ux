...
export class BindingComponent extends ViewInfoComponent implements OnDestroy {
    ...
    constructor( @Inject(ElementRef) elementRef: ElementRef,
        ...
        super('binding', _functionAppService, _broadcastService);
    ...
    setup(): Subscription {
        return this.viewInfoEvents
            .switchMap(viewInfo => Observable.zip(
                this._functionAppService.getFunctionAppAzureAppSettings(viewInfo.context),

...
export class SlotNewComponent extends BaseFunctionComponent implements OnDestroy {
    ...
    constructor(
        ...
        super('slot-new', broadcastService, _functionAppService, () => _globalStateService.setBusyState(), DashboardType.CreateSlotDashboard);
    }

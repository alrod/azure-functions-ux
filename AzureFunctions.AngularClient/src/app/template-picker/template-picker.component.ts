...
export class TemplatePickerComponent extends ViewInfoComponent {
    ...
    constructor(
        ...
        super('template-picker', _functionAppService, broadcastService, () => _globalStateService.setBusyState());
    ...
    set type(type: TemplatePickerType) {
        ...
        this._functionAppService.getTemplates(this.context).subscribe((templates) => {
            this._functionAppService.getBindingConfig(this.context).subscribe((config) => {
                this._globalStateService.clearBusyState();
                if (config.isSuccessful && templates.isSuccessful) {
                    this.bindings = config.result.bindings;
                    this.templates = [];
                    switch (type) {

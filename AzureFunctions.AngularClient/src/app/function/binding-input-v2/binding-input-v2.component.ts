...
export class BindingInputV2Component extends ViewInfoComponent {
    ...
    constructor(
        ...
        super('binding-input-v2', _functionAppService, _broadcastService, () => this._globalStateService.setBusyState());

...
export abstract class ViewInfoComponent extends ErrorableComponent implements OnDestroy {
    ...
    private viewInfoSubject: Subject<TreeViewInfo<any>>;
    ...
    constructor(componentName: string, functionAppService: FunctionAppService, broadcastService: BroadcastService, setBusy?: Function) {
